...
# unique-unordered-finite.
# it cannot having the key values.
# it canot follow the order. 
# when u can re run the the order will be changed.
# u can print multiple times in a single execution it can be same order.
# by using set to find the duplicate elements.
